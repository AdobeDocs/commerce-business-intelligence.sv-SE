...
Det finns fyra sätt att få in data på [!DNL Commerce Intelligence]: ansluta en databas, ansluta en SaaS-integration, överföra en `.csv` eller använd Adobe API.
...
Du kan ansluta databasen direkt till [!DNL Commerce Intelligence] om du använder databasautentiseringsuppgifter rekommenderar Adobe att du använder en beprövad krypteringsmetod, som en SSH-tunnel. Detta garanterar att dina data förblir säkra och säkra när de kommer in i Datan Warehouse.
...
Vet du inte hur du hämtar data från en extra källa till Datan Warehouse? [Använda `File Upload` funktion](../connecting-data/using-file-uploader.md) är ett bra sätt att hämta in data som ni inte behöver för det dagliga beslutsfattandet. Om du följer formateringsreglerna kan du snabbt överföra `.csv` filer i Datan Warehouse och koppla dem till andra datakällor.
...
Om du vill lägga till en integrering klickar du **[!UICONTROL Manage Data** > **Connections]** och sedan klicka **[!UICONTROL Add a New Data Source]**. Klicka på ikonen för den integrering som du vill lägga till och följ instruktionerna i hjälpavsnitten för att konfigurera saker:
...
**Ser du ingen integrering?** Vissa integreringar måste aktiveras för att de ska visas på ditt konto. Om du letar efter något som [!DNL Facebook] men den finns inte med i listan, [skicka en supportanmälan](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/mbi-service-policies.html).
